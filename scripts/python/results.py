...
games_df = pd.read_csv(f".data/{games_file_name}", header=None, skiprows=1)
reviews_df = pd.read_csv(f".data/{reviews_file_name}")
...
print("Query 4:")
print("===========")
for index, value in enumerate(q4_results_games_names.head(25), start=1):
    print(f"{index}: {value}")
...
print("Query 5:")
print("===========")
for index, value in enumerate(q5_result_with_game_names[["app_id", "Name"]]['Name'].head(10), start=1):
    print(f"{index}: {value}")